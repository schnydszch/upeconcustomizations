        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>images/uplodo.ico</xsl:text>
                </xsl:attribute>
            </link>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
							...
							<img src="{$theme-path}images/upse-header.jpg" />
                        </a>
                        ...
                        <ul class="nav nav-pills pull-left ">
                            ...
                            dri:metadata[@element='identifier' and @qualifier='url']}">
                                            ...
                                            <li>
                                                <a href="/ir/submissions">
												<!--<a href="{/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='page'][@qualifier='jumpTo']}">-->
        ...
        <footer>
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-8">
                        <div>
                            <a href="http://www.dspace.org/" target="_blank">University of the Philippines</a> copyright&#160;&#169;&#160;2019&#160; <a href="https://www.up.edu.ph
" target="_blank"></a>
                        </div>
